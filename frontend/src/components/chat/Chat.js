...
const Chat = () => {
	const sendBtnClick = () => {
		setMessages((prevMessages) => [
			...prevMessages,
			{ user: "user", msg: "age is " },
		]);

		if (personal_info === "") {
			setMessages((prevMessages) => [
				...prevMessages,
				{ user: "ai", msg: "So what are the symptoms you're feeling?" },
			]);
		}
		console.log("clicked");
	};
	const [messages, setMessages] = useState([]);
	const [personal_info, setPinfo] = useState("");
	return (
		<div className="flex bg-[#F6F6F6] w-screen h-screen">
			...
			<div className="flex flex-col w-3/4 border border-black">
				...
				<div className="overflow-y-scroll">
					<div className="text-center pt-10 mb-20">
						<p className="text-4xl pb-6">
							IT’s Billie your favourite health assistant
						</p>
					...
					<div id="messages">
						<div className="w-[80%] items-start flex mx-auto gap-10 mb-10">
							...
							<div className="flex flex-col">
								<p className="bg-[#C5D4D3] mb-8 py-4 px-6 rounded-3xl rounded-tl-none w-[100%] text-xl">
									Hey i am Billie your favourite health
									assistant. I’m best at helping you with
									recieving your medical symptoms and Giving
									you a quick response on your possible health
									condition 🤩
								</p>
								<p className="bg-[#C5D4D3] mb-2 py-4 px-6 rounded-3xl rounded-tl-none w-[100%] text-xl">
									Whats is your age and sex?
								</p>
				...
				<div className="">
					<ChatBox sendBtnClick={sendBtnClick} />
				</div>
			</div>
		</div>
	);
